...
namespace VolcanionAuth.Infrastructure.Persistence.Migrations
{
    ...
    public partial class InitializeDatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserAttributes_UserId_AttributeKey",
                table: "UserAttributes",
                columns: new[] { "UserId", "AttributeKey" });

            migrationBuilder.CreateIndex(
                name: "IX_UserRelationships_SourceUserId_TargetUserId_RelationshipType",
                table: "UserRelationships",
                columns: new[] { "SourceUserId", "TargetUserId", "RelationshipType" },
                unique: true);
